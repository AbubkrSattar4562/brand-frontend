            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-7 gap-2">
                {Array.from({ length: 35 }, (_, i) => (
                  <div
                    key={i}
                    className="aspect-square border border-brand-beige rounded p-1 text-xs cursor-pointer transition-all duration-300 ease-in-out hover:shadow-md hover:scale-105 hover:border-brand-warm-brown"
                  >
                    {i % 7 === 0 && i < 28 ? (
                      <div className="bg-brand-soft-beige text-brand-charcoal rounded px-1 py-0.5 text-xs font-poppins transition-all duration-300 ease-in-out hover:bg-brand-warm-brown hover:text-brand-cream hover:shadow-sm hover:scale-105 transform">
                        Content
                      </div>
                    ) : (
                      <div className="text-brand-warm-brown font-poppins rounded p-1 h-full flex items-center justify-center transition-all duration-300 ease-in-out hover:text-brand-cream hover:bg-brand-warm-brown hover:shadow-sm hover:scale-105 transform hover:font-semibold">
                        {(i % 30) + 1}
                      </div>
                    )}
                  </div>
